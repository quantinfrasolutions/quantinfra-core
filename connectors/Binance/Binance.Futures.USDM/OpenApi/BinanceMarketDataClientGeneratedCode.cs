...
namespace QuantInfra.Binance.Futures.USDM.MarketData
{
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public BinanceMarketDataClient(System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual System.Threading.Tasks.Task<OrderBookSnapshot> GetOrderBookSnapshotAsync(string symbol, double? limit)
        {
            return GetOrderBookSnapshotAsync(symbol, limit, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<OrderBookSnapshot> GetOrderBookSnapshotAsync(string symbol, double? limit, System.Threading.CancellationToken cancellationToken)
        {
            if (symbol == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "fapi/v1/depth"
                    urlBuilder_.Append("fapi/v1/depth");
                    urlBuilder_.Append('?');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<OrderBookSnapshot>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class OrderBookSnapshot
    {
        ...
        public System.Collections.Generic.List<System.Collections.Generic.List<decimal>> Bids { get; set; } = new System.Collections.Generic.List<System.Collections.Generic.List<decimal>>();

        [System.Text.Json.Serialization.JsonPropertyName("asks")]
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.List<System.Collections.Generic.List<decimal>> Asks { get; set; } = new System.Collections.Generic.List<System.Collections.Generic.List<decimal>>();
        ...
        public static OrderBookSnapshot FromJson(string data)
        {

            var options = new System.Text.Json.JsonSerializerOptions();

            return System.Text.Json.JsonSerializer.Deserialize<OrderBookSnapshot>(data, options);
