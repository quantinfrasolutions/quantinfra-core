...
namespace QuantInfra.Connectors.Common.Crypthography
{
    ...
    static class ASN1
    {
                    ...
                    case 0xA1:
                        {
                            ...
                            if (contentStream.ReadByte() == 0x03)
                            {
                                ...
                                {
                                    byte[] pubkey = new byte[childStream.Length - 2];
        ...
        static byte[] ReadToken(Stream stream)
        {
    ...
    sealed class ASN1ECKeyStructure
    {        
