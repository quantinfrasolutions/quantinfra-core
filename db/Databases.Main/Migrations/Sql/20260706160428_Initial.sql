...
CREATE SEQUENCE static_data.brokers_seq AS integer START WITH 102 INCREMENT BY 1 NO CYCLE;
...
CREATE SEQUENCE static_data.datafeeds_seq AS integer START WITH 101 INCREMENT BY 1 NO CYCLE;

CREATE SEQUENCE static_data.exchanges_seq AS integer START WITH 120 INCREMENT BY 1 NO CYCLE;
...
INSERT INTO static_data.brokers (broker_id, broker_type, name)
VALUES (100, 'Ibkr', 'Interactive Brokers');
INSERT INTO static_data.brokers (broker_id, broker_type, name)
VALUES (101, 'BinanceUsdmFutures', 'Binance USD-m Futures');

INSERT INTO static_data.datafeeds (datafeed_id, name)
VALUES (100, 'Default datafeed');

INSERT INTO static_data.exchanges (exchange_id, name, timezone)
VALUES (119, 'Binance USD-m Futures', 'UTC');
...
-- VALUES ('20260706160428_Initial', '9.0.8');
-- 
-- COMMIT;
-- 
-- 