...
DROP INDEX idx_time_bau_close_dt;

DROP INDEX idx_time_bau_open_dt;

DROP INDEX idx_time_bau_stream_id;

CREATE INDEX idx_time_bau_stream_id_open_dt ON time_bau (stream_id, open_dt);

CREATE INDEX idx_time_bau_close_dt_open_dt ON time_bau (close_dt, open_dt);
...
-- VALUES ('20240108110739_IndexesAndFunctionsOptimization', '7.0.11');
